...
var irregularTable = [
    ...
    /* ..우다 */
    /* $냐 */{ pattern: /\b우$/, fix: '워' },
    /* $냐 */{ pattern: /\b우라$/, fix: '워라' },
    /* $까 */{ pattern: /\b울$/, fix: '워' },
    /* $까 */{ pattern: /\b울자$/, fix: '우자' },
    /* $까 */{ pattern: /\b울라$/, fix: '워라' },
    /* $까 */{ pattern: /\b울지 마$/, fix: '우지 마' },
    /* $야돼 */{ pattern: /\b워자$/, fix: '우자' },
    /* $야돼 */{ pattern: /\b워지 마$/, fix: '우지 마' },
    /* $야돼 */{ pattern: /\b워지 말든지$/, fix: '우지 말든지' },
    /* $야겠지 */{ pattern: /\b워면 안 되지$/, fix: '우면 안 되지' },
    /* $도 */{ pattern: /\b워든지$/, fix: '우든지' },
