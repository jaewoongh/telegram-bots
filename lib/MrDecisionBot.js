...
var irregularTable = [
    ...
    /* ..우다 */
    /* $냐 */{ pattern: /\W우$/, fix: '워' },
    /* $냐 */{ pattern: /\W우라$/, fix: '워라' },
    /* $까 */{ pattern: /\W울$/, fix: '워' },
    /* $까 */{ pattern: /\W울자$/, fix: '우자' },
    /* $까 */{ pattern: /\W울라$/, fix: '워라' },
    /* $까 */{ pattern: /\W울지 마$/, fix: '우지 마' },
    /* $야돼 */{ pattern: /\W워자$/, fix: '우자' },
    /* $야돼 */{ pattern: /\W워지 마$/, fix: '우지 마' },
    /* $야돼 */{ pattern: /\W워지 말든지$/, fix: '우지 말든지' },
    /* $야겠지 */{ pattern: /\W워면 안 되지$/, fix: '우면 안 되지' },
    /* $도 */{ pattern: /\W워든지$/, fix: '우든지' },
