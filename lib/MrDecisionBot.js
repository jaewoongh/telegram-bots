...
var keywordList = [
    ...
    { keyword: /(\S+)까[\.\?]*$/, behavior: 'pickOne', parameter: ['$', '아니', '$자', 'ㄴㄴ', '$라', '$지 마', '어', '$면 안 되지'] }
];
...
var irregularTable = [
    ...
    /* ..렇다 */
    /* $냐 */{ pattern: /렇$/, fix: '그래' },
    /* $냐 */{ pattern: /렇라$/, fix: '그래라' },
    /* $까 */{ pattern: /럴$/, fix: '그래' },
    /* $까 */{ pattern: /럴자$/, fix: '그러자' },
    /* $까 */{ pattern: /럴라$/, fix: '그래라' },
    /* $까 */{ pattern: /럴지 마$/, fix: '그러지 마' },
    /* $야돼 */{ pattern: /래자$/, fix: '그러자' },
    /* $야돼 */{ pattern: /래지 마$/, fix: '그러지 마' },
    /* $야돼 */{ pattern: /래지 말든지$/, fix: '그러지 말든지' },
    /* $야겠지 */{ pattern: /래면 안 되지$/, fix: '그러면 안 되지' },
    /* $도 */{ pattern: /래든지$/, fix: '그러든지' },
