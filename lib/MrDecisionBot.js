...
var keywordList = [
    ...
    { keyword: /(\S+)냐[^까]*마냐/, behavior: 'pickOne', parameter: ['$', '말어', '$자', '말자', '$라', '$지 마', '$', '$지 마'] },
    { keyword: /(\S+)까[^까]*말까/, behavior: 'pickOne', parameter: ['$', '말어', '$자', '말자', '$라', '$지 마', '$', '$지 마'] },
    { keyword: /(\S+)야\s?돼[^까]*말아야\s?돼/, behavior: 'pickOne', parameter: ['$', '말어', '$자', '말자', '$라', '$지 마', '$', '$지 마'] },
    { keyword: /(\S+)야\s?하냐[^까]*말아야\s?하냐/, behavior: 'pickOne', parameter: ['$', '말어', '$자', '말자', '$라', '$지 마', '$', '$지 마'] },
    { keyword: /(\S+)야\s?되냐[^까]*말아야\s?되냐/, behavior: 'pickOne', parameter: ['$', '말어', '$자', '말자', '$라', '$지 마', '$', '$지 마'] },
...
var irregularTable = [
    ...
    /* $까 */{ pattern: /울자$/, fix: '우자' },
    /* $까 */{ pattern: /울라$/, fix: '워라' },
    /* $까 */{ pattern: /울지 마$/, fix: '우지 마' },
    /* $야돼 */{ pattern: /워자$/, fix: '우자' },
    /* $야돼 */{ pattern: /워지 마$/, fix: '우지 마' },
    /* $야돼 */{ pattern: /워지 말든지$/, fix: '우지 말든지' },
    /* $야겠지 */{ pattern: /워면 안 되지$/, fix: '우면 안 되지' },
    /* $도 */{ pattern: /워든지$/, fix: '우든지' },
    ...
    /* ..울다 */
    /* $냐 */{ pattern: /우$/, fix: '울어' },
    /* $냐 */{ pattern: /우라$/, fix: '울어라' },
    /* $까 */{ pattern: /울$/, fix: '올어' },
    /* $까 */{ pattern: /울라$/, fix: '울어라' },
    /* $야돼 */{ pattern: /울어자$/, fix: '울자' },
    /* $야돼 */{ pattern: /울어지 마$/, fix: '울지 마' },
    /* $야돼 */{ pattern: /울어지 말든지$/, fix: '울지 말든지' },
    /* $야겠지 */{ pattern: /울어면 안 되지$/, fix: '울면 안 되지' },
    /* $도 */{ pattern: /울어든지$/, fix: '울든지' },
